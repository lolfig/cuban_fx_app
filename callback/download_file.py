...
from layouts.layout_data_status import in_dbc_save_btn
from reactivity import out_file_download
from services.framework_scraping.tools.missing_dates import load_day_files
...
def generate_buffer_zipfile():
  ...
  with zipfile.ZipFile(buffer, "w") as zip_file:
    ...
    for file in load_day_files(DIR_DATA_MESSAGES):

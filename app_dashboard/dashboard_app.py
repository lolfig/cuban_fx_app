...
avg_daily_messages, messages_compra, messages_venta, percent_compra, percent_venta = (
    cache.get_messages_metrics(analytics)
)
                        ...
                        dbc.Col(
                            html.Img(
                                src=app.get_asset_url(
                                    "/home/ale/Projects/cuban_fx_app/assets/logo_clean.png"
                                ),
                                style={
                                    "display": "block",
                                    "margin": "0 auto",
